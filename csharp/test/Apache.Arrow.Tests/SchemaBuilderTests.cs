    ...
    public class SchemaBuilderTests
    {
        public class Build
        {
            ...
            public void MetadataConstruction()
            {
                ...
                Assert.Equal(schema0.GetHashCode(), schema2.GetHashCode());
                Assert.False(schema0.Equals(schema1));
                Assert.NotEqual(schema0.GetHashCode(), schema1.GetHashCode());
                Assert.False(schema2.Equals(schema1));
                Assert.NotEqual(schema2.GetHashCode(), schema1.GetHashCode());
                Assert.False(schema2.Equals(schema3));
                Assert.NotEqual(schema2.GetHashCode(), schema3.GetHashCode());
            }
